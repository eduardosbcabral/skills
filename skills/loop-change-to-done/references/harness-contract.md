...
Treat local repository guidance as feedforward control for the loop. If local guidance conflicts with the user request, surface the conflict before implementing.
